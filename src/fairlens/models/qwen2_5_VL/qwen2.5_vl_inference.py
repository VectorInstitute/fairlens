...
MODEL_VARIANT = "Qwen2.5-VL-7B-Instruct"
...
MAX_TOKENS = _model_max_tokens('qwen2_5_VL')
_ROOT = fairlens_root()
...
def run_inference(image_path, questions, system_prompt):
    ...
    for q in questions:
        ...
        inputs = processor(text=[text], images=img_inputs, videos=vid_inputs, padding=True, return_tensors="pt").to(model.device)
